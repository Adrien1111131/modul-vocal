...
class AudioEnvironmentService {
  ...
  private async loadAudioFile(url: string): Promise<AudioBuffer> {
    ...
    try {
      // Utiliser le générateur de sons de test
      let blob: Blob;
      const fileName = url.split('/').pop()?.split('.')[0];
      
      switch (fileName) {
        case 'bedroom_ambience':
          blob = await testSoundGenerator.generateBedroomAmbience();
          break;
        case 'ocean_waves':
          blob = await testSoundGenerator.generateOceanWaves();
          break;
        case 'forest_ambience':
          blob = await testSoundGenerator.generateForestAmbience();
          break;
        case 'rain':
          blob = await testSoundGenerator.generateRain();
          break;
        case 'city_ambience':
          blob = await testSoundGenerator.generateCityAmbience();
          break;
        case 'fireplace':
          blob = await testSoundGenerator.generateFireplace();
          break;
        case 'night_ambience':
          blob = await testSoundGenerator.generateNightAmbience();
          break;
        case 'water_stream':
          blob = await testSoundGenerator.generateWaterStream();
          break;
        case 'cafe_ambience':
          blob = await testSoundGenerator.generateCafeAmbience();
          break;
        case 'space_ambience':
          blob = await testSoundGenerator.generateSpaceAmbience();
          break;
        default:
          // Son par défaut
          blob = await testSoundGenerator.generateBedroomAmbience();
